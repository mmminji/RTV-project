...
if __name__ == "__main__":
    ...
    csv_file = csv_file[(csv_file['C_AIRFORCE_DETECT_TARGET_RANGE']<30) & (csv_file['C_AIRFORCE_DETECT_TARGET_COURSE']>0)]
    ...
    new_csv.to_csv(os.path.join(new_folder_generate,'T_AIRFORCE_DETECT_tmp.csv'), index = False)
